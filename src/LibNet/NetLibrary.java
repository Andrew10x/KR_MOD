...
public static PetriNet CreateTestNet() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_P.add(new PetriP("P2",0));
	d_P.add(new PetriP("P3",0));
	d_T.add(new PetriT("T1",5.0));
	d_T.get(0).setDistribution("exp", d_T.get(0).getTimeServ());
	d_T.get(0).setParamDeviation(0.0);
	d_T.add(new PetriT("T2",7.0));
...
/*public static PetriNet CreateNettest4() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
...
public static PetriNet CreateNet22() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_T.get(1).setPriority(1);
	d_T.get(1).setProbability(0.145);
	d_T.add(new PetriT("T3",4.0));
	d_T.get(2).setPriority(1);
	d_T.get(2).setProbability(0.855);
	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
	d_In.add(new ArcIn(d_P.get(1),d_T.get(1),1));
	d_In.add(new ArcIn(d_P.get(1),d_T.get(2),1));
	d_In.add(new ArcIn(d_P.get(4),d_T.get(1),1));
...
public static PetriNet CreateNetUntitled11() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	/*public static PetriNet CreateDryCleaning11() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
		ArrayList<PetriP> d_P = new ArrayList<>();
		ArrayList<PetriT> d_T = new ArrayList<>();
		ArrayList<ArcIn> d_In = new ArrayList<>();
		ArrayList<ArcOut> d_Out = new ArrayList<>();
		d_P.add(new PetriP("Gen",1));
		d_P.add(new PetriP("QueueToOp1",0));
		d_P.add(new PetriP("Op1IsFree",1));
		d_P.add(new PetriP("JacketsQueue",0));
		d_P.add(new PetriP("JacketsQueue2",0));
		d_P.add(new PetriP("TrousersQueue2",0));
		d_P.add(new PetriP("DamagedSuits",0));
		d_P.add(new PetriP("GivenAwayUndamagedSuits",0));
		d_P.add(new PetriP("GivenAwayDamagedSuits",0));
		d_P.add(new PetriP("Op2IsFree",1));
		d_P.add(new PetriP("Op4IsFree",1));
		d_P.add(new PetriP("Op5IsFree",1));
		d_P.add(new PetriP("TrousersQueue",0));
		d_P.add(new PetriP("Op3IsFree",1));
		d_P.add(new PetriP("P1",0));
		d_P.add(new PetriP("NumberOfDamagedSuits",0));
		d_T.add(new PetriT("GenT",10.0));
		d_T.get(0).setDistribution("exp", d_T.get(0).getTimeServ());
		d_T.get(0).setParamDeviation(0.0);
		d_T.add(new PetriT("GatherDamagedSuits",8.0));
		d_T.get(1).setDistribution("exp", d_T.get(1).getTimeServ());
		d_T.get(1).setParamDeviation(0.0);
		d_T.get(1).setPriority(1);
		d_T.get(1).setProbability(0.145);
		d_T.add(new PetriT("GiveAwayDamagedSuits",12.0));
		d_T.get(2).setDistribution("exp", d_T.get(2).getTimeServ());
		d_T.get(2).setParamDeviation(0.0);
		d_T.add(new PetriT("divideSuit",6.0));
		d_T.get(3).setDistribution("exp", d_T.get(3).getTimeServ());
		d_T.get(3).setParamDeviation(0.0);
		d_T.add(new PetriT("JacketCleaning",5.0));
		d_T.get(4).setDistribution("exp", d_T.get(4).getTimeServ());
		d_T.get(4).setParamDeviation(0.0);
		d_T.add(new PetriT("TrousersCleaning",4.0));
		d_T.get(5).setDistribution("exp", d_T.get(5).getTimeServ());
		d_T.get(5).setParamDeviation(0.0);
		d_T.add(new PetriT("GatherUndamagedSuits",5.0));
		d_T.get(6).setDistribution("exp", d_T.get(6).getTimeServ());
		d_T.get(6).setParamDeviation(0.0);
		d_T.get(6).setPriority(1);
		d_T.get(6).setProbability(0.855);
		d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
		d_In.add(new ArcIn(d_P.get(4),d_T.get(1),1));
		d_In.add(new ArcIn(d_P.get(5),d_T.get(1),1));
		...
		d_In.add(new ArcIn(d_P.get(13),d_T.get(5),1));
		...
		d_Out.add(new ArcOut(d_T.get(4),d_P.get(9),1));
		d_Out.add(new ArcOut(d_T.get(2),d_P.get(11),1));
		d_Out.add(new ArcOut(d_T.get(1),d_P.get(10),1));
		d_Out.add(new ArcOut(d_T.get(3),d_P.get(12),1));
		d_Out.add(new ArcOut(d_T.get(5),d_P.get(13),1));
		d_Out.add(new ArcOut(d_T.get(5),d_P.get(5),1));
		d_Out.add(new ArcOut(d_T.get(6),d_P.get(10),1));
		d_Out.add(new ArcOut(d_T.get(6),d_P.get(7),1));
		d_Out.add(new ArcOut(d_T.get(0),d_P.get(14),1));
		d_Out.add(new ArcOut(d_T.get(1),d_P.get(15),1));
		PetriNet d_Net = new PetriNet("24",d_P,d_T,d_In,d_Out);
		PetriP.initNext();
		PetriT.initNext();
		ArcIn.initNext();
		ArcOut.initNext();
...
public static PetriNet CreateDryCleaningNet() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_P.add(new PetriP("TrousersQueue",0));
	d_P.add(new PetriP("Op3IsFree",1));
	d_P.add(new PetriP("NumberOfArrivedSuits",0));
	d_P.add(new PetriP("NumberOfDamagedSuits",0));
	d_T.add(new PetriT("GenT",10.0));
	d_T.get(0).setDistribution("exp", d_T.get(0).getTimeServ());
	d_T.get(0).setParamDeviation(0.0);
	...
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(14),1));
	d_Out.add(new ArcOut(d_T.get(1),d_P.get(15),1));
	PetriNet d_Net = new PetriNet("30",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet CreateNet32() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_T.get(5).setProbability(0.855);
	d_T.add(new PetriT("T1",12.0));
	d_T.get(6).setDistribution("exp", d_T.get(6).getTimeServ());
	d_T.get(6).setParamDeviation(0.0);
	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
	d_In.add(new ArcIn(d_P.get(4),d_T.get(1),1));
	...
	d_Out.add(new ArcOut(d_T.get(1),d_P.get(10),1));
	d_Out.add(new ArcOut(d_T.get(2),d_P.get(12),1));
	...
	PetriNet d_Net = new PetriNet("32",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet CreateNet33() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	d_P.add(new PetriP("1", "Gen",1));
	d_P.add(new PetriP("2", "QueueToOp1",0));
	d_P.add(new PetriP("3", "NumberOfArrivedSuits",0));
	d_P.add(new PetriP("4", "Op1IsFree",1));
	d_P.add(new PetriP("5", "JacketsQueue",0));
	d_P.add(new PetriP("6", "TrousersQueue",0));
	d_P.add(new PetriP("7", "Op2IsFree",1));
	d_P.add(new PetriP("8", "Op3IsFree",1));
	d_P.add(new PetriP("9", "JacketsQueue2",0));
	d_P.add(new PetriP("10", "TrousersQueue2",0));
	d_P.add(new PetriP("11", "Op4IsFree",1));
	d_P.add(new PetriP("12", "DamagedSuits",0));
	d_P.add(new PetriP("13", "GivenAwayUndamagedSuits",0));
	d_P.add(new PetriP("14", "NumberOfDamagedSuits",0));
	d_P.add(new PetriP("15", "Op5IsFree",1));
	d_P.add(new PetriP("16", "GivenAwayDamagedSuits",0));
	d_T.add(new PetriT("GenT",10.0));
	d_T.get(0).setDistribution("exp", d_T.get(0).getTimeServ());
	d_T.get(0).setParamDeviation(0.0);
	d_T.add(new PetriT("divideSuit",6.0));
	...
	d_T.get(4).setParamDeviation(0.0);
	d_T.get(4).setPriority(1);
	d_T.get(4).setProbability(0.145);
	d_T.add(new PetriT("GatherUndamagedSuits",5.0));
	d_T.get(5).setDistribution("exp", d_T.get(5).getTimeServ());
	d_T.get(5).setParamDeviation(0.0);
	d_T.get(5).setPriority(1);
	...
	d_In.add(new ArcIn(d_P.get(4),d_T.get(2),1));
	d_In.add(new ArcIn(d_P.get(6),d_T.get(2),1));
	d_In.add(new ArcIn(d_P.get(10),d_T.get(4),1));
	d_In.add(new ArcIn(d_P.get(5),d_T.get(3),1));
	d_In.add(new ArcIn(d_P.get(7),d_T.get(3),1));
	d_In.add(new ArcIn(d_P.get(10),d_T.get(5),1));
	d_In.add(new ArcIn(d_P.get(9),d_T.get(5),1));
	d_In.add(new ArcIn(d_P.get(8),d_T.get(5),1));
	d_In.add(new ArcIn(d_P.get(11),d_T.get(6),1));
	d_In.add(new ArcIn(d_P.get(14),d_T.get(6),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(0),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
	...
	d_Out.add(new ArcOut(d_T.get(3),d_P.get(9),1));
	d_Out.add(new ArcOut(d_T.get(5),d_P.get(10),1));
	d_Out.add(new ArcOut(d_T.get(5),d_P.get(12),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(2),1));
	d_Out.add(new ArcOut(d_T.get(4),d_P.get(13),1));
	d_Out.add(new ArcOut(d_T.get(6),d_P.get(14),1));
	d_Out.add(new ArcOut(d_T.get(6),d_P.get(15),1));
	PetriNet d_Net = new PetriNet("32",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	...
	/*public static PetriNet CreateNet35() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
		ArrayList<PetriP> d_P = new ArrayList<>();
		ArrayList<PetriT> d_T = new ArrayList<>();
		ArrayList<ArcIn> d_In = new ArrayList<>();
		ArrayList<ArcOut> d_Out = new ArrayList<>();
		...
		d_P.add(new PetriP("NumberOfDamagedSuits",0));
		d_T.add(new PetriT("GenT",10.0));
		d_T.get(0).setDistribution(null, d_T.get(0).getTimeServ());
		d_T.get(0).setParamDeviation(0.0);
		d_T.add(new PetriT("GatherDamagedSuits",8.0));
		d_T.get(1).setDistribution(null, d_T.get(1).getTimeServ());
		d_T.get(1).setParamDeviation(0.0);
		d_T.get(1).setPriority(1);
		d_T.get(1).setProbability(0.145);
		d_T.add(new PetriT("divideSuit",6.0));
		d_T.get(2).setDistribution(null, d_T.get(2).getTimeServ());
		d_T.get(2).setParamDeviation(0.0);
		d_T.add(new PetriT("JacketCleaning",5.0));
		d_T.get(3).setDistribution(null, d_T.get(3).getTimeServ());
		d_T.get(3).setParamDeviation(0.0);
		d_T.add(new PetriT("TrousersCleaning",4.0));
		d_T.get(4).setDistribution(null, d_T.get(4).getTimeServ());
		d_T.get(4).setParamDeviation(0.0);
		d_T.add(new PetriT("GatherUndamagedSuits",5.0));
		d_T.get(5).setDistribution(null, d_T.get(5).getTimeServ());
		d_T.get(5).setParamDeviation(0.0);
		d_T.get(5).setPriority(1);
		d_T.get(5).setProbability(0.855);
		d_T.add(new PetriT("GiveAwayDamagedSuit",12.0));
		d_T.get(6).setDistribution(null, d_T.get(6).getTimeServ());
		d_T.get(6).setParamDeviation(0.0);
		d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
		d_In.add(new ArcIn(d_P.get(4),d_T.get(1),1));
		d_In.add(new ArcIn(d_P.get(5),d_T.get(1),1));
...
public static PetriNet CreateDryCleaningNet(double genT, double divideSuitT, double gatherUndamagedSuitsT,
								   double gatherDamagedSuitsT) throws ExceptionInvalidNetStructure,
	...
	d_P.add(new PetriP("NumberOfArrivedSuits",0));
	d_P.add(new PetriP("NumberOfDamagedSuits",0));
	d_T.add(new PetriT("GenT",genT));
	d_T.get(0).setDistribution("exp", d_T.get(0).getTimeServ());
	d_T.get(0).setParamDeviation(0.0);
	d_T.add(new PetriT("GatherDamagedSuits",gatherDamagedSuitsT));
	d_T.get(1).setDistribution("exp", d_T.get(1).getTimeServ());
	d_T.get(1).setParamDeviation(0.0);
	d_T.get(1).setPriority(1);
	d_T.get(1).setProbability(0.145);
	d_T.add(new PetriT("divideSuit",divideSuitT));
	d_T.get(2).setDistribution("exp", d_T.get(2).getTimeServ());
	d_T.get(2).setParamDeviation(0.0);
	d_T.add(new PetriT("JacketCleaning",5.0));
	d_T.get(3).setDistribution("exp", d_T.get(3).getTimeServ());
	...
	d_T.get(4).setDistribution("exp", d_T.get(4).getTimeServ());
	d_T.get(4).setParamDeviation(0.0);
	d_T.add(new PetriT("GatherUndamagedSuits",gatherUndamagedSuitsT));
	d_T.get(5).setDistribution("exp", d_T.get(5).getTimeServ());
	d_T.get(5).setParamDeviation(0.0);
	d_T.get(5).setPriority(1);
	d_T.get(5).setProbability(0.855);
